			...
			<form class="form-horizontal" method="post" enctype="multipart/form-data" novalidate="">
				<div class="box-body">
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" maxlength="20" onkeypress="return blockSpecialChar(event)"class="form-control" id="first_name" name="first_name" placeholder="First Name" value="<?php echo $_POST['first_name']; ?>" required />
							<?php echo $errors['first_name']; ?>
						</div>
						<div class="col-sm-5">
							<input type="text" maxlength="15" onkeypress="return blockSpecialChar(event)"class="form-control" id="last_name" name="last_name" placeholder="Last Name" value="<?php echo $_POST['last_name']; ?>" required />
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<div class="input-group">
								<input type="text" maxlength="15" onkeypress="return blockSpecialChar(event)"class="form-control" id="dob" name="dob" placeholder="MM/DD/YYYY" value="<?php echo $_POST['dob']; ?>" required />
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" maxlength="15" onkeypress="return blockSpecialChar(event)"class="form-control" id="nationality" name="nationality" placeholder="Nationality" value="<?php echo $_POST['nationality']; ?>" required />
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<textarea class="form-control" maxlength="30" onkeypress="return blockSpecialChar(event)" id="address" name="address" placeholder="Address" required><?php echo $_POST['address']; ?></textarea>
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text" maxlength="15" onkeypress="return blockSpecialChar(event)" class="form-control" id="city" name="city" placeholder="City" value="<?php echo $_POST['city']; ?>" required />
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text" maxlength="15" onkeypress="return blockSpecialChar(event)"class="form-control" id="state" name="state" placeholder="State" value="<?php echo $_POST['state']; ?>" required />
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text" maxlength="15" onkeypress="return blockSpecialChar(event)"class="form-control" id="country" name="country" placeholder="Country" value="<?php echo $_POST['country']; ?>" required />
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="email" maxlength="20" class="form-control" id="email" name="email" placeholder="Email Id" value="<?php echo $_POST['email']; ?>" required />
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="number" maxlength="12" onkeypress="return blockSpecialChar(event)"class="form-control" id="mobile" name="mobile" placeholder="Mobile No" value="<?php echo $_POST['mobile']; ?>" required />
							<?php echo $errors['mobile']; ?>
						</div>
						<div class="col-sm-5">
							<input type="number" maxlength="15" onkeypress="return blockSpecialChar(event)"class="form-control" id="telephone" name="telephone" value="<?php echo $_POST['telephone']; ?>" placeholder="Telephone No" />
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="number" maxlength="8" onkeypress="return blockSpecialChar(event)" class="form-control" id="id_no" name="id_no" placeholder="Identification No" value="<?php echo $_POST['id_no']; ?>" required />
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select class="form-control" id="employment_type" name="employment_type">
								<option value="">Please make a choice</option>
								<option <?php echo $_POST['employment_type']=='Cook' ? 'selected' : ''; ?> value="Cook">Cook</option>
								<option <?php echo $_POST['employment_type']=='Cleaner' ? 'selected' : ''; ?> value="Cleaner">Cleaner</option>
								<option <?php echo $_POST['employment_type']=='Cashier' ? 'selected' : ''; ?> value="Cashier">Cashier</option>
								<option <?php echo $_POST['employment_type']=='Dishwasher' ? 'selected' : ''; ?> value="Dishwasher">Dishwasher</option>
							</select>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<div class="input-group">
								<input type="text" maxlength="15" onkeypress="return blockSpecialChar(event)" class="form-control" id="joining_date" name="joining_date" placeholder="MM/DD/YYYY" value="<?php echo $_POST['joining_date']; ?>" required />
								<span class="input-group-addon">
									<i class="glyphicon glyphicon-calendar"></i>
								</span>
							</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							<input type="text" maxlength="2" class="form-control" id="bloodgrp" name="bloodgrp" placeholder="Blood Group" value="<?php echo $_POST['bloodgrp']; ?>" required />
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							<input type="password" maxlength="15" onkeypress="return blockSpecialChar(event)"class="form-control" id="emp_password" name="emp_password" placeholder="Password" value="<?php echo $_POST['emp_password']; ?>" required />
